...
Client.prototype._invoke = function(method, args, location, callback, options, extraHeaders) {
  var self = this,
    ...
    xmlnsSoap = "xmlns:" + envelopeKey + "env=\"http://schemas.xmlsoap.org/soap/envelope/\"";

  if (this.wsdl.options.forceSoap12Headers) {
    headers["Content-Type"] = "application/soap+xml; charset=utf-8";
    xmlnsSoap = "xmlns:" + envelopeKey + "env=\"http://www.w3.org/2003/05/soap-envelope\"";
  }
  ...
  xml = "<?xml version=\"1.0\" encoding=\"utf-8\"?>" +
    "<" + envelopeKey + "env:Envelope " +
    xmlnsSoap + " " +
    "xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" " +
    encoding +
    this.wsdl.xmlnsInEnvelope.replace(":tns",":ws") + '>' +
    ((self.soapHeaders || self.security) ?
      (
        "<" + envelopeKey + "env:Header>" +
